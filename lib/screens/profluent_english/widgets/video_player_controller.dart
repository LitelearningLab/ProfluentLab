...
import 'package:litelearninglab/screens/profluent_english/widgets/material_video_progress_controller.dart';
...
class _MaterialControlsState extends State<CustomController> with SingleTickerProviderStateMixin {
      ...
      child: AnimatedOpacity(
        ...
        child: Container(
          ...
          padding: EdgeInsets.only(
            left: 10,
            bottom: !chewieController.isFullScreen ? 0 : 0,
          ),
          child: SafeArea(
            top: false,
  ...
  Widget _buildHitArea() {
    ...
    return GestureDetector(
      ...
      child: AnimatedOpacity(
          opacity: notifier.hideStuff ? 0.0 : 1.0, duration: const Duration(milliseconds: 300), child: SizedBox()),*/
    );
  }
  ...
  void _updateState() {
    ...
    if (chewieController.progressIndicatorDelay != null) {
      ...
      print("Removed this for circular progress loadind indicator");
      //_displayBufferingIndicator = controller.value.isBuffering;
      print("displayBuffieringIndicator:${controller.value.isBuffering}");
    }
