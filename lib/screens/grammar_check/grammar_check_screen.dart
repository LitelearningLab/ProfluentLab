...
class GrammarCheckScreen extends StatefulWidget {
  GrammarCheckScreen({Key? key, required this.title, required this.load}) : super(key: key);
  final String title;
  final String load;
            ...
            child: _isLoading == false
                ? ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      Map<Object?, Object?>? firstData = dataMap[dataList[index].toString()] as Map<Object?, Object?>;
                      List<Object?> firstDataList = firstData.keys.toList();
                      Map<Object?, Object?>? internalData =
                          firstData[firstDataList[0].toString()] as Map<Object?, Object?>;
                      ...
                      return DropDownWordItem(
                        ...
                        initiallyExpanded: _selectedWordOnClick != null && _selectedWordOnClick == entry.key.toString(),
                              ...
                              child: Row(
                                children: [
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      print("d dddd");
                                      String? learningModuleValue = internalData["Learningmodule"].toString();
                                      print("learningModuleValue : $learningModuleValue");
                                      SharedPreferences prefs = await SharedPreferences.getInstance();
                                      await prefs.setStringList('InAppWebViewPage', [learningModuleValue ?? ""]);
                                      await prefs.setString('lastAccess', 'InAppWebViewPage');
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) => InAppWebViewPage(url: learningModuleValue ?? "")));
                                    },
                                    child: Row(
                                      children: [
                                        Image.asset(AllAssets.interaction, width: 25, height: 25, color: Colors.white),
                                        SPW(5),
                                        Text(
                                          "Learning Module",
                                  ...
                                  InkWell(
                                    onTap: () async {
                                      String? exerciseValue = internalData["Exercise"].toString();
                                      ...
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) => InAppWebViewPage(url: exerciseValue ?? "")));
                                    },
                                    child: Wrap(
                                      children: [
                                        Image.asset(
