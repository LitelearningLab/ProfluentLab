...
class fastTrackPronunciationScreen extends StatefulWidget {
  fastTrackPronunciationScreen({Key? key, required this.title})
      : super(key: key);

  final ProfluentEnglish title;

  @override
  State<fastTrackPronunciationScreen> createState() =>
      _fastTrackPronunciationScreenState();
}

late AuthState sentenceRepeatUser;
String sentenceRepeatLoad = "";

class _fastTrackPronunciationScreenState
    extends State<fastTrackPronunciationScreen> {
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () async {
                              ...
                              activityName = "Video";
                              print(
                                  "video url:${widget.title.subcategories![index].videoLink!}");
                              // _isLoading = false;
                              // setState(() {});
                              SharedPreferences prefs =
                                  await SharedPreferences.getInstance();
                              await prefs.setStringList('InAppWebViewPage', [
                                widget.title.subcategories![index].videoLink!
                              ]);
